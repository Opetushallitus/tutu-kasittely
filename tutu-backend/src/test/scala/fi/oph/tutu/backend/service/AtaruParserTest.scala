...
class AtaruParserTest extends UnitTestBase with TutuJsonFormats {
  ...
  def parseTutkinnotWithGeneratedIds(): Unit = {
    ...
    assertEquals(None, tutkinto1.paaAineTaiErikoisala)
    ...
    assertEquals(None, tutkinto2.paaAineTaiErikoisala)
    ...
    assertEquals(None, tutkinto3.paaAineTaiErikoisala)
    ...
    assertEquals(None, muuTutkinto.paaAineTaiErikoisala)
