...
case class Tutkinto(
  ...
  nimiAlkuperaiskielella: Option[String] = None,
  nimiKaannoksessa: Option[String] = None,
  oppilaitos: Option[String] = None,
  oppilaitosAlkuperaiskielella: Option[String] = None,
  oppilaitosKaannoksessa: Option[String] = None,
