...
const Raamit = () => {
  useEffect(() => {
    if (!isTest()) {
      if (document.querySelector('script[data-raamit]')) return;
      const script = document.createElement('script');
      script.src = raamitUrl();
      script.async = true;
      script.dataset.raamit = '';
      script.onerror = () => {
        script.remove();
        console.error('Error loading virkailija raamit');
      };
  ...
  createRoutesFromElements(
    <Route path="/" element={<RootLayout />}>
      ...
      <Route path="/hakemus/:oid/*" element={<HakemusLayout />}>
        ...
        <Route path="perustelu/yleiset/perustelut" element={<YleisetPage />} />
        <Route path="perustelu/yleiset/lausunto" element={<Lausuntotiedot />} />
        ...
        <Route path="yhteinenkasittely" element={<YhteinenKasittelyPage />} />
