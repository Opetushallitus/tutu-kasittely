...
import { Sisalto } from '@/src/app/hakemus/perustiedot/components/Sisalto';
import { TranslatedHakemuskoskee } from '@/src/app/hakemus/perustiedot/components/TranslatedHakemuskoskee';
